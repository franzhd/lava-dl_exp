...
class Network(torch.nn.Module):
    def __init__(self, input, output, treshold, voltage_decay, threshold_step, threshold_decay, refractory_decay, max_event_rate):
...
def main():
    ...
    net = Network(6, 7, params['treshold'], params['voltage_decay'], params['treshold']*params['threshold_step'], params['threshold_decay'], params['refractory_decay'], params['max_rate']).to(device)
